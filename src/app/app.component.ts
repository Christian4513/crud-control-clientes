...
// Importa el componente para gestionar clientes

// Decorador del componente principal de la aplicación
@Component({
  selector: 'app-root',
  // Selector para el componente en la plantilla HTML

  standalone: true,
  // Indica que este es un componente standalone

  imports: [RouterOutlet, CabeceroComponent, PiePaginaComponent, ClientesComponent],
  // Importa los componentes necesarios para el funcionamiento del componente

  templateUrl: './app.component.html',
  // Archivo de plantilla HTML del componente

  styleUrls: ['./app.component.css'],
  // Archivo de estilos CSS del componente

  providers: []
  // Se pueden agregar proveedores de servicios aquí si es necesario
})
